...
/// Draw line
    ...
    pygame.draw.ellipse(screen, color, (x, y, width, height) 1)
    pygame.draw.arc(screen, color, (x, y, width, height) 1)

/// text
    font = pygame.font.Font(None, 50)
    text1 = font.render('My Txt', True, color)
    text2 = font.render('My Txt', False, color)
...
while not done:
    ...
    text2 = font.render('My text2' , False, RED)
    screen.blit(text1, [250, 250])
    screen.blit(text2, [250, 300])
    # text rotation
    font = pygame.font.SysFont("Calibri", 25, True, False) # zhirnost' - 3, kursiv - 4
